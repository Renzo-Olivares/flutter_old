...
class InlineSpanReplacementManager {
  ...
  void setReplacement(TextEditingInlineSpanReplacement replacement) {
  ...
  void adjustReplacementRanges(TextDelta textDelta) {
...
class ReplacementTextEditingController extends TextEditingController {
  ...
  List<TextEditingInlineSpanReplacement>? replacements;
  InlineSpanReplacementManager? replacementManager;
  ...
  void applyReplacement(TextEditingInlineSpanReplacement replacement) {
    replacementManager.setReplacement(replacement);
  }
  ...
  set value(TextEditingValue newValue) {
    ...
    replacementManager.adjustReplacementRanges(newValue.delta);
    super.value = newValue;
  }
